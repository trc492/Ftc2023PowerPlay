...
//	}
	...
	public void setRedAlliance(boolean redAlliance)
	{
		if (redAlliance)
		{
			hsvThresholdHue = new double[] {0.0, 75.0};
			hsvThresholdSaturation = new double[] {75.0, 200.0};
			hsvThresholdValue = new double[] {220.0, 255.0};
		}
		else
		{
			hsvThresholdHue = new double[] {0.0, 75.0};
			hsvThresholdSaturation = new double[] {200.0, 255.0};
			hsvThresholdValue = new double[] {100.0, 255.0};
		}
	}	//setRedAlliance
